...
function GetMilesPerGalon(Miles){
var allCarWithMoreMiles=[]

    for (let index = 0; index < carsArr.length; index++) {
        var currentcar=carsArr[index]
        if (currentcar.Miles_per_Gallon>Miles) {
             allCarWithMoreMiles.push(currentcar)
...
return allCarWithMoreMiles
}
var resultcar=GetMilesPerGalon(40)
...
function getBooksByCountryNG2(bookname) {
    return books.filter((currentBook) => currentBook.title.toLowerCase() === bookname.toLowerCase())
}

function getBooksByCountryNG3(author) {
    return books.filter((currentBook) => currentBook.author.toLowerCase() === author.toLowerCase())
}

console.log(getBooksByCountryNG2("The Divine Comedy"));
console.log(getBooksByCountryNG3("Giovanni Boccaccio"));